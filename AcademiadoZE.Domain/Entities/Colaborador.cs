...
public class Colaborador : Pessoa
{
    ...
    private const int IdadeMinimaAnos = 18;
    ...
    public static Result<Colaborador> Criar(
        int id, string? nome, string? cpf, DateOnly dataNascimento, string? telefone, string? email,
        ...
        DateOnly dataAdmissao, ColaboradorTipo tipo, ColaboradorVinculo vinculo)
    {
        ...
        var colaborador = new Colaborador(
            id, nome!, cpfResult.Value!, dataNascimento, telefoneResult.Value!, emailResult.Value!,
